...
//echo $value;
	$_SESSION['mess']="";
$Name='';
$q1="select * from Customer where C_email='$value'";
$sql ="select count(B_ID) from booking";

$_SESSION['ID']="";

	$exe_q1=mysqli_query($con,$q1);
	$d1=mysqli_fetch_assoc($exe_q1);
	$Name=$d1['C_Name'];
    $C_ID=$d1['C_ID'];
	$_SESSION['ID']=$C_ID;
...
<tr>
<td   style="width:100%;" >
   <img src="images/33.png" style="   display: block; margin-left: auto; margin-right: auto;width: 100%;" id ="letred">
  </td><td>
  ...
  <tr>
<td   style="width:50%;"  >
   <img src="images/22.png" style="   display: block; margin-left: auto; margin-right: auto;width: 100%;" id ="letred">
  </td>
	<td>
  ...
  <tr>
<td   style="width:50%;"  >
   <img src="images/11.png" style="   display: block; margin-left: auto; margin-right: auto;width: 100%;" id ="letred" >
  </td>
<td>
  ...
  <td>
        ...
        <div class="container-fluid" id="mainheader">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="our-link">
                        <ul>
                            <li><a href="#"><i class="fa fa-user s_color"><?php echo $Name; ?></i></a></li>
                    ...
                    <div class="text-slid-box">
                        <div id="offer-box" class="carouselTicker">
                            <ul class="offer-box">
                                ...
                                <li>
                                    <i class="fab fa-opencart"></i> 50% - 80% off on cookies
                                </li>
                                <li>
                                    <i class="fab fa-opencart"></i> Off 10%! Cakes
                                </li>
                                <li>
                                    <i class="fab fa-opencart"></i> Off 50%! Shop Now
                                </li>
                                <li>
                                    <i class="fab fa-opencart"></i> Off 10%! Snow White Cakes
                                </li>
                                <li>
                                    <i class="fab fa-opencart"></i> 50% - 80% off on Red Black Cakes
                                </li>
                                <li>
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="dropdown">
						 ...
						 <li class="nav-item"><a id="b36" class="nav-link" href="index.php">logout</a></li>
        ...
        <ul class="slides-container">
            <li class="text-center">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="m-b-20"><strong>Welcome To <br> Customized Bakery</strong></h1>
                            <p class="m-b-40">We let you design your own cake <br> Be creative and Tasty</p>
                            <p><a id="b2" class="btn hvr-hover" href="#">Shop New</a></p>
                        </div>
                    </div>
                </div>
            </li>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box" >
                        <img class="img-fluid" src="images/categories_img_01.png" alt="" />
                        <a id="b3" class="btn hvr-hover" href="#">Snow white cake</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box" >
                        <img class="img-fluid" src="images/categories_img_02.png" alt="" />
                        <a id="b4" class="btn hvr-hover" href="#">Cake</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box" >
                        <img class="img-fluid" src="images/categories_img_03.png" alt="" />
                        <a id="b5" class="btn hvr-hover" href="#">Red & white Cake</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12"  >
                    <div class="title-all text-center">
                        <h1>Bakery Product</h1>
                        <p> Bakery designed products</p>
                    </div>
                </div>
            </div>
            <div class="row"  >
                ...
                <div class="col-lg-3 col-md-6 special-grid best-seller">
                    <div class="products-single fix">
                        <div class="box-img-hover">
                            ...
                            <img src="images/img-pro-03.png" class="img-fluid" alt="Image">
                            <div class="mask-icon">
                                <ul>
                        ...
                        <div class="why-text">
                            <h4>Strawberry and blueberry</h4>
                            <h5 id="b32"> £7.79</h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 special-grid top-featured">
                    <div class="products-single fix">
                        <div class="box-img-hover">
                            ...
                            <img src="images/img-pro-02.png" class="img-fluid" alt="Image">
                            <div class="mask-icon">
                                <ul>
                ...
                <div class="col-lg-3 col-md-6 special-grid best-seller">
                    <div class="products-single fix">
                        <div class="box-img-hover">
                            ...
                            <img src="images/img-pro-04.png" class="img-fluid" alt="Image">
                            <div class="mask-icon">
                                <ul>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-12 col-sm-12">
                        <div class="footer-widget">
							...
							<p>How your bakery product will look like and How you can design it</p> 							
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-12 col-sm-12">
    ...
    <div class="footer-copyright">
        <p class="footer-company">All Rights Reserved. &copy; 2020 <a href="#">Customized Bakery</a></p>
    </div>
    <!-- End copyright  -->
