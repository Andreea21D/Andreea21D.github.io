...
<body style=" background-image: url('images/back412.jpg');
  background-repeat: no-repeat;
  background-attachment: fixed;
  background-size: cover;">

    <!-- start menu -->
    <div class="menu" style=" background-image: url('images/back412.jpg');
  background-repeat: no-repeat;
  background-attachment: fixed;
  background-size: cover;">
	  	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	  <a class="navbar-brand" href="index.php">customized<small> bakery</small></a>
	...
	<!-- end menu -->
        <div class="main" style=" background-image: url('images/back412.jpg');
  background-repeat: no-repeat;
  background-attachment: fixed;
  background-size: cover;">
...
<span id="e6" style ="color:red"><?php echo $repasswordErr; ?></span>
         ...
         <div class="footer-bottom" style=" background-image: url('images/back412.jpg');
  background-repeat: no-repeat;
  background-attachment: fixed;
  background-size: cover;">
  </div>
		  ...
		  <div class="container" style="background-color: #000000;">
		    <div class="copy" style="background-color: #000000;">
		        <p>© 2020 <a href="http://w3layouts.com" target="_blank">Customized Bakery</a></p>
		    </div>
