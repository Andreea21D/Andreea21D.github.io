  ...
  <td>
            ...
            <div class="container"   >
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="nav-item active"><a id="b1" class="nav-link" href="about.php">About Us</a></li>
                        <li class="dropdown">
    ...
    <div class="about-box-main" id="mainheader2">
        <div class="container">
            <div class="row">
				<div class="col-lg-6">
                    <div class="banner-frame"> <img class="img-fluid" src="Cake-Bakery.jpg" alt="" />
                    </div>
                </div>
                <div class="col-lg-6">
                    <h2 class="noo-sh-title-top">We will <span>cook as you ask to</span></h2>
                    <p>  We are the best in town to bake your customized baked whatever you like.  </p>
                    <p></p>
            ...
            <div class="row my-5">
                <div class="col-sm-6 col-lg-4">
                    <div class="service-block-inner">
                        ...
                        <p>Custom will get every thing original </p>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4">
                    <div class="service-block-inner">
                        <h3>We are Professional</h3>
                        <p> We bake with care </p>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4">
                    <div class="service-block-inner">
                        <h3>We are Expert</h3>
                        <p>Cooking is art we are the best </p>
                    </div>
                </div>
            </div>
            <div class="row my-4">
