...
function order(){
	//window.alert("Add ten  straberry"+s+c+v);
	if(!s && c && v){
...
window.alert("Please drop item");
 ...
 //window.alert("simple Strwbery cake");
 document.getElementById("cake_images").src="st1.jpg";
 box4();
 }else if(cakeitem[0]=='ch'){
 
  //window.alert("simple chocolate cake");
  document.getElementById("cake_images").src="ch0.jpg";
 box4();
 
 }else if(cakeitem[0]=='v'){
 
  //window.alert("simple vall cake");
  document.getElementById("cake_images").src="v.jpg";
 box4();
 }
 ...
 if(cakeitem[0]=='st' && cakeitem[1]=='ch'){
 
 //window.alert("two Strwbery chocolate cake");
 document.getElementById("cake_images").src="stch1.jpg";
 box4();
 }else if(cakeitem[1]=='st' && cakeitem[0]=='ch'){
 
  //window.alert("two Strwbery chocolate cake");
 document.getElementById("cake_images").src="stch1.jpg";
 box4();
 
 }else if(cakeitem[0]=='v' && cakeitem[1]=='ch'){
 
  //window.alert("two vallian chocolate cake");
  document.getElementById("cake_images").src="chv.jpg";
 box4();
 }else if(cakeitem[1]=='v' && cakeitem[0]=='ch'){
 
  //window.alert("two vallian chocolate cake");
  document.getElementById("cake_images").src="chv.jpg";
 box4();
 }else if(cakeitem[0]=='st' && cakeitem[1]=='v'){
 
  //window.alert("two vallian strawbreey cake");
  document.getElementById("cake_images").src="stv.jpg";
 box4();
 }else if(cakeitem[1]=='st' && cakeitem[0]=='v'){
 ...
 box4();
  ...
  document.getElementById("cake_images").src="stchv.jpg";
 box4();
...
top1++;
s=false;
}else if(value='ch'){cakeitem[top1]=value;top1++;c=false;}else if('v'){cakeitem[top1]=value;top1++;v=false;}
...
<tr>
<th ><h2 style="  font-weight: bold; color: #000000;"><strong>Cake looks like that</strong></h2></th>
...
<td   style="width:50%;" >
  ...
  <td   style="width:50%;" >
  	<button class="button button1" onclick="order();">Order placed<button>
    ...
    <header class="main-header"   >
        <!-- Start Navigation -->
        <nav  id="mainheader1" style="z-index:2;"  class="navbar navbar-expand-lg navbar-light con navbar-default bootsnav" >
            <div class="container"   >
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"><img src="images/logo.png" class="logo" alt="No image"></a>
                </div>
                <!-- End Header Navigation -->

                <!-- Collect the nav links, forms, and other content for toggling -->
                <div class="collapse navbar-collapse" style="z-index:2;" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="dropdown">
                           ...
                           <li class="nav-item"><a id="b36" class="nav-link" href="Design.php">Design Cake</a></li>
    ...
    <!-- Start All Title Box -->
    <div class="all-title-box" style="background: url('./images/banner-01.jpg') no-repeat center center;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Customized Cake</li>
                    </ul>
                </div>
            </div>
        </div>
...
<div class="banner-frame"  width="100px" style=" border: 2px solid black; min-height:400px;  height: 100%;
  width: 100%;"> <ul>
  <li><img id="st" src="st1.png" draggable="true" value="Strwbery" ondragstart="drag(event)"  width="100px"  height="100px" ></li>
  <li><img id="ch" src="ch1.jpg" draggable="true" value="Cho" ondragstart="drag(event)" width="100px"  height="100px"></li>
   <li><img id="v" src="v.png" draggable="true" value="Cho" ondragstart="drag(event)" width="100px"  height="100px"></li>
  
  <li><button class="button button1" onclick="box()" value="process">Bake it</button></li>
</ul></div>
...
<label class="container1">Strwbery
  <input id="cs" type="checkbox"  onclick="itemc('st');">
  <span class="checkmark"></span>
</label>
<label class="container1">Chocolate
  <input id="cc" type="checkbox" onclick="itemc('ch');">
  <span class="checkmark"></span>
</label>
<label class="container1">vanilla 
  <input id="cv" type="checkbox" onclick="itemc('v');">
  <span class="checkmark"></span>
</label>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-12 col-sm-12">
                        <div class="footer-widget">
                            <h4>About Customized Bakery</h4>
                            <p>We are here to let you decide</p> 
							<p>How your bakery product will look like</p> 							
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-12 col-sm-12">
    ...
    <div class="footer-copyright">
        <p class="footer-company">All Rights Reserved. &copy; 2020 <a href="#">Customized Bakery</a>
    </div>
    <!-- End copyright  -->
